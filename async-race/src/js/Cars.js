...
class Cars {
  ...
  render() {
    ...
    const deleteButtons = garagePlayground.querySelectorAll("button.delete");
    const selectButtons =
      garagePlayground.querySelectorAll("button.btn-select");
    const startButtons = garagePlayground.querySelectorAll("button.start");
    const stopButtons = garagePlayground.querySelectorAll("button.stop");
